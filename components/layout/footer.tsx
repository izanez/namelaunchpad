  ...
  return (
    <footer className="mt-20 border-t border-white/10 bg-slate-950/70">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 pt-10 md:px-6">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl md:p-8">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-300">
            ...
            <Link href="/username-generator" className="text-cyan-300 hover:text-cyan-200">
              Username Generator
            </Link>
            ,{" "}
            <Link href="/fortnite-name-generator" className="text-cyan-300 hover:text-cyan-200">
              Fortnite Name Generator
            </Link>
            ,{" "}
            <Link href="/roblox-username-generator" className="text-cyan-300 hover:text-cyan-200">
              Roblox Username Generator
            </Link>
            ,{" "}
            <Link href="/fantasy-name-generator" className="text-cyan-300 hover:text-cyan-200">
              Fantasy Name Generator
            </Link>
            , and{" "}
            <Link href="/clan-name-generator" className="text-cyan-300 hover:text-cyan-200">
              Clan Name Generator
            </Link>
            . Each generator is built to help users discover names that are readable, memorable, and ready to use
            across gaming, streaming, and social platforms.
          </p>
        </div>
      </div>
      <div className="mx-auto grid w-full max-w-6xl gap-8 px-4 py-10 md:grid-cols-3 md:px-6">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-400">
            Premium username platform for unique gaming names, clan tags, and streaming aliases.
          </p>
        </div>
        <div>
          ...
          <ul className="mt-2 space-y-1 text-sm text-slate-400">
            ...
            <li>
              <Link href="/explore-generators" className="hover:text-cyan-300">
                Explore Generators
              </Link>
            </li>
            <li>
              <Link href="/all-generators" className="hover:text-cyan-300">
                All Generators
              </Link>
            </li>
            <li>
      ...
      <div className="border-t border-white/10 py-4 text-center text-xs text-slate-500">
        Copyright {new Date().getFullYear()} NameLaunchpad. Built for gamers, creators, and streamers.
      </div>
    </footer>
  );
}
